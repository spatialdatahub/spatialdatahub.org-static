...
L.Control.Watermark = L.Control.extend({
    onAdd: (map) => {
        ...
        img.src = 'http://localhost/static/images/zmt_logo_blue_black_100px.png';
        // img.src = imgSrc
...
L.Control.HomeButton = L.Control.extend({
    onAdd: (map) => {
        ...
        container.style.backgroundImage = 'url("http://localhost/static/images/home_icon.png")';
...
L.Control.ToggleScrollButton = L.Control.extend({
    onAdd: (map) => {
        ...
        container.style.backgroundImage = 'url("http://localhost/static/images/mouse.png")';
        container.style.backgroundRepeat = 'no-repeat';
        container.style.backgroundColor = 'white';
        container.style.width = '34px';
        container.style.height = '34px';
